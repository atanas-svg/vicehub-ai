  ...
  return (
    <section className="relative z-10 mx-auto max-w-7xl px-6 pb-20 pt-16 text-center md:pt-24">
      ...
      <p className="mx-auto mt-7 max-w-2xl text-lg leading-8 text-gray-300 md:text-xl">
        ViceHub AI helps you search, build your setup, plan money, vehicles,
        weapons, map routes, dashboard progress, saved items, roadmap updates
        and 100% completion from one clean futuristic hub.
      </p>
